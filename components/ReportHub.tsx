...
// ── 3) 운행시작 보고 패널 (첫 운행시작 전 점검사항 공유) ────────
type Status = "" | "ok" | "issue";

// 체크 항목 한 줄 — 체크박스 + 라벨(+ 설명)
function CheckRow({
  checked,
  onChange,
  label,
...
// 첫차 운행시작 전 점검 결과 → 팀즈(설치 진행중 공유방) 카드.
// 금일완료 리포트의 운행시작 점검란과 항목은 같지만, 첫차 운행 직후 바로 공유하는 창구.
...
// ── 통합 보고 버튼 + 탭 팝업 ─────────────────────────────────
type TabKey = "plan" | "start" | "progress" | "service";
