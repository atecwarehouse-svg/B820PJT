      ...
      <Card>
        <ol className="space-y-3 text-sm text-gray-700">
          <Step n={1} title="차량번호 입력">
            ...
            이동합니다. 이후는 <b>이상유무 → 설치 전 → 설치 후</b> 3단계 화면으로 진행됩니다.
          </Step>
          <Step n={2} title="1단계 — 차량 이상유무 확인 (8종 + 추가 가능)">
            팀명을 선택하고, 작업 시작 전 전광판 · 차량계기판 · 안내방송 · 타코메타 · 시계 ·
            CCTV · 전자노선도 · 빈좌석표시기를 촬영합니다. 필요한 항목(칸)은 직접 추가할 수
            있고, 장비가 없는 항목은 <b>‘없음’ 체크</b>, 이상 내용은 <b>비고(필수)</b>에
            기록한 뒤 ‘다음’으로 넘어갑니다. 팀명은 한번 저장되면 관리자만 변경할 수 있습니다.
          </Step>
          <Step n={3} title="2단계 — 설치 전 사진 (7칸 + 추가 가능)">
            차량번호 · GPS안테나 · 운전자 조작기 · 통합단말기 · 승차/하차 단말기를 촬영합니다.
            하차 단말기가 없는 차량은 ‘단말기 없음’ 체크로 대신합니다.
          </Step>
          <Step n={4} title="3단계 — 설치 후 사진 (7칸) + 특이사항 → 저장">
            설치 완료된 장비 사진을 칸에 맞춰 올리고 특이사항(필수)을 적은 뒤 <b>저장</b>을
            누르면 목록에 등록되고 팀즈 알림이 발송됩니다. 사진은 자동 압축되고, 회전(눕혀
            찍힘)된 사진은 AI가 걸러냅니다.
          </Step>
        </ol>
        <p className="mt-3 rounded-lg bg-blue-50 px-3 py-2 text-[13px] leading-relaxed text-blue-700">
          💡 사진·입력은 그때그때 자동 저장되며, 차량에 다시 들어오면 <b>완료된 단계는
          건너뛰고 이어서</b> 시작합니다. ‘← 이전’ 버튼으로 언제든 앞 단계를 확인·수정할 수
          있습니다.
        </p>
      </Card>
      <Card>
